...
import kurtka5 from "./assets/img/kurtka5.jpg";
...
import kurtka14 from "./assets/img/kurtka14.jpg";
import kurtka15 from "./assets/img/kurtka15.jpg";
  ...
  return (
    <div className='container shop-boxes'>
        ...
        <div className="variant">
            ...
            <p className='shop-p'>192 010 сум</p>
            <p>⭐⭐⭐⭐</p>
        ...
        <div className="variant">
            ...
            <p className='shop-p'>80 700 сум</p>
            <p>⭐⭐⭐⭐</p>
        ...
        <div className="variant">
            ...
            <p className='shop-p'>296 000 сум</p>
            <p>⭐⭐⭐⭐</p>
            <mark shop-mark>28900 сумм/мес</mark>
            <button class="shopBtn"><i class="fa-solid fa-bag-shopping"></i>Savat</button>
        </div>
        <div className="variant">
            <img className='shop-img' src={kurtka5} alt="photo" style={{ width: "200px", height: "240px"}}/>
            <p className='shop-p-second'>Миттенка, Перчатки для женщин и девочек, Перчатки без пальцев, Теплые, Подарок, Аксес</p>
            <p className='shop-p'>69 000 сум</p>
            <p>⭐⭐⭐⭐</p>
            <mark shop-mark>5200 сумм/мес</mark>
            <button class="shopBtn"><i class="fa-solid fa-bag-shopping"></i>Savat</button>
        </div>
        <div className="variant">
            <img className='shop-img' src={kurtka6} alt="photo" style={{ width: "200px", height: "240px"}}/>
            <p className='shop-p-second'>Женская зимняя куртка с клетчатой подкладкой, утеплённая, свободного кроя  Подарок Теп</p>
            <p className='shop-p'>269 900 сум</p>
            <p>⭐⭐⭐⭐</p>
            <mark shop-mark>21 179 сумм/мес</mark>
            <button class="shopBtn"><i class="fa-solid fa-bag-shopping"></i>Savat</button>
        </div>
        <div className="variant">
            <img className='shop-img' src={kurtka7} alt="photo" style={{ width: "200px", height: "240px"}}/>
            <p className='shop-p-second'>Шапка-бини унисекс, шапка, не закрывающая ушей, доггер, зимняя, бини шапка</p>
            <p className='shop-p'>45 700 сум</p>
            <p>⭐⭐⭐⭐</p>
            <mark shop-mark>3470 сумм/мес</mark>
            <button class="shopBtn"><i class="fa-solid fa-bag-shopping"></i>Savat</button>
        </div>
        <div className="variant">
            <img className='shop-img' src={kurtka8} alt="photo" style={{ width: "200px", height: "240px"}}/>
            <p className='shop-p-second'>Детская куртка демисезонная для мальчиков и девочек, на зиму пуховик</p>
            <p className='shop-p'>168 000 сум</p>
            <p>⭐⭐⭐⭐</p>
         ...
         <div className="variant">
            ...
            <p className='shop-p'>158 000 сум</p>
            <p>⭐⭐⭐⭐</p>
         ...
         <div className="variant">
            ...
            <p className='shop-p'>33 100 сум</p>
            <p>⭐⭐⭐⭐</p>
         ...
         <div className="variant">
            ...
            <p className='shop-p'>151 050 сум</p>
            <p>⭐⭐⭐⭐</p>
        ...
        <div className="variant">
            ...
            <p className='shop-p'>359 100 сум</p>
            <p>⭐⭐⭐⭐</p>
         ...
         <div className="variant">
            ...
            <p className='shop-p'>144 090 сум</p>
            <p>⭐⭐⭐⭐</p>
            <mark shop-mark>10625 сумм/мес</mark>
            <button class="shopBtn"><i class="fa-solid fa-bag-shopping"></i>Savat</button>
        </div>
        <div className="variant">
            <img className='shop-img' src={kurtka14} alt="photo" style={{ width: "200px", height: "240px"}}/>
            <p className='shop-p-second'>Женский тёплый спортивный костюм с худи, двойка, осень, зима, весна</p>
            <p className='shop-p'>287 990 сум</p>
            <p>⭐⭐⭐⭐</p>
            <mark shop-mark>21249 сумм/мес</mark>
            <button class="shopBtn"><i class="fa-solid fa-bag-shopping"></i>Savat</button>
        </div>
        <div className="variant">
            <img className='shop-img' src={kurtka15} alt="photo" style={{ width: "200px", height: "240px"}}/>
            <p className='shop-p-second'>Свитшот женский SADO SADO  Стильные непромокаемые весна-осень-зима</p>
            <p className='shop-p'>191 040 сум</p>
            <p>⭐⭐⭐⭐</p>
            <mark shop-mark>21179 сумм/мес</mark>
            <button class="shopBtn"><i class="fa-solid fa-bag-shopping"></i>Savat</button>
        </div>
    </div>
  )
